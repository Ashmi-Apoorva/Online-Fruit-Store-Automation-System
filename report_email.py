#!/usr/bin/env python3
#This script processes the supplier fruit description data and generates a message using the reports script created earlier and then sends the email using the methods in the emails script
import os
import datetime
import reports
import emails
